...
/**
 * A basic sinewave jMusic instrument implementation
 * which implements frequency, envelope, volume, and panoramic control, in real time.
 * @author Andrew Sorensen and Bill Manaris
 */

public final class SinewaveInstrument extends jm.audio.Instrument
{
	//----------------------------------------------
	// Attributes
	//----------------------------------------------
	 ...
	 * @param sampleRate 
	 */
	public SinewaveInstrument(int sampleRate)
	{
	 ...
	 */
	public SinewaveInstrument(int sampleRate, int channels)
	{
		this.sampleRate = sampleRate;
	...
	*/
	public SinewaveInstrument(int sampleRate, int channels, double[] envelopePoints)
	{
		this.sampleRate = sampleRate;
		this.channels = channels;
	...
	*/
	public SinewaveInstrument(int sampleRate, int channels, double[] envelopePoints, float frequency)
	{
		this.sampleRate = sampleRate;
		this.channels = channels;
		this.envelopePoints = envelopePoints;
