################################################################################################################
# guicontrols.py        Version 1.10     22-Feb-2017      Bill Manaris, Marge Marshall, Seth Stoudenmier, and Robert Ziehr
#
...
class XYPad(Rectangle):
   ...
   def __updateXYPad__(self, x, y):
      ...
      #newY = y
      newX = x - self.topLeftXCoordinate                            # store new fader value
      newY = y - self.endY_JPanel + (2 * self.topLeftYCoordinate)   # store new fader value
